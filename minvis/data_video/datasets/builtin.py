...
_PREDEFINED_SPLITS_YTVIS_2019 = {
    "ytvis_2019_train": ("/workspace/VIS/pseudo_v9_track",
                       "/workspace/VIS/pseudo_v9_track/annotations_yt.json"),
    "ytvis_2019_val": ("/workspace/VIS/pseudo_v9_track",
                       "/workspace/VIS/pseudo_v9_track/annotations_yt.json"),
    "ytvis_2019_test": ("/workspace/VIS/pseudo_v9_track",
                       "/workspace/VIS/pseudo_v9_track/annotations_yt.json"),
}
